...
const name = 'admin'; ///This provides the database manager the name of the target collection in the database
var instance;
...
module.exports = {
     ...
     * @example format({name: 'Timo Werner', email: 'timo.werner@gmail.com', title: 'SV-Vorsitzender', scopes: [0, 1], password: 'mercedes1234'}, true);
     * @param {JSON} object
     * @async
     * @returns JSON
     */
    format: async (object, hashPassword) => {
        return {
            name: object.name,
            email: object.email,
            title: (object.title != undefined) ? object.title : 'Schüler', ///New in v2, Working tilte within the organisation ex. Head-Developer, SV, Teacher, Administration etc.
            scopes: object.scopes,
            password: hashPassword ? await crypto.encript(object.password): object.password,
            iat: Date.now(),
            access: []
        }
    }
