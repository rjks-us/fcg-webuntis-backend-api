...
const name = 'devices'; ///This provides the database manager the name of the target collection in the database
var instance;
...
module.exports = {
    ...
    format: (object) => {
        ...
        if(object.push) user.push.push({token: object.push, iat: Date.now()});
