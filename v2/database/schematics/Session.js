...
const name = 'session'; ///This provides the database manager the name of the target collection in the database
var instance;
...
module.exports = {
    ...
    format: async (object, hashPassword) => {
        return {
            session: hashPassword ? await crypto.encript(object.token) : object.token,
            iat: Date.now(),
            exp: object.exp,
