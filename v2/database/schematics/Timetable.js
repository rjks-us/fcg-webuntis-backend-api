...
const name = 'timetable'; ///This provides the database manager the name of the target collection in the database
var instance;
    ...
    format: (object) => {
        return {
            ...
            subject: {
                ...
                short: object.subject.short,
                short: object.subject.name,
            },
            teacher: {
